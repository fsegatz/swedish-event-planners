...
def main():
    ...
    lenght_before_append = len(database.eventPlanning_List)
    ...
    if (lenght_before_append != len(database.eventPlanning_List)):
        print("Test: length of eventPlanning_List changed")
